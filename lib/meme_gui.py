...
class Meme_Finder:
    def __init__(self, top=None):
        ...
        self.set_style(top, _bgcolor, _fgcolor, _compcolor, _ana2color)
    ...
    def settings(self, top):
        ...
        self.filemenu.add_command(
            label="Enter subreddits to collect",
            command=lambda: meme_gui_support.settings_collect())
        self.filemenu.add_command(
            label="Add new subreddits",
            command=lambda: meme_gui_support.settings_add())
    ...
    def next_menu(self, top):
        ...
        self.nextimg.configure(
            command=lambda: meme_gui_support.next(
                self.Canvas1))
    ...
    def prev_menu(self, top):
        ...
        self.previmg.configure(
            command=lambda: meme_gui_support.prev(
                self.Canvas1))
    ...
    def search_button(self, top):
        ...
        self.go.configure(
            command=lambda: meme_gui_support.go(
                self.Canvas1,
